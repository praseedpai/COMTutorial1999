////////////////////////////////////////////////////////////////////////////
// Sample Client Application for AddressList and Address Object 
//
//
//
...
///////////////////////////////////////////////
//
// Helper Function for Printing an Address into console 
//
//
...
////////////////////////////////////////////////////
//
//Helper Function for Instantiating Address Object 
//
...
int __cdecl _tmain(int argc, TCHAR* argv[], TCHAR* envp[])
{
    ...
    // do not forget to call this before any COM library calls
	//
	...
	{
		cout << "Unable To Initialize Com Library";
